...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Arquitetura.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x111f0
SOPC_SYSID_FLAG += --sidp=0x111f0
ELF_PATCH_FLAG  += --sidp 0x111f0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1643898709
SOPC_SYSID_FLAG += --timestamp=1643898709
ELF_PATCH_FLAG  += --timestamp 1643898709
