...
void we_DEC(int data_MSB, int data_LSB){
...
void we_CTL(int data_MSB, int data_LSB){
...
void we_MIRQ(int data_MSB, int data_LSB){
...
int state_KEY(int button){
	...
	unsigned int data = data & ~(1 << (2 + button));
	we_DEC(data_MSB, data);
