...
SOPCINFO_FILE := C:/Users/thiag/Downloads/CoLendaFPGA/CoLendaFPGA/DE0-Nano/Arquitetura.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Arquitetura
SOPC_NAME := Arquitetura
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11110
SOPC_SYSID_FLAG += --sidp=0x11110
ELF_PATCH_FLAG  += --sidp 0x11110

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1728871358
SOPC_SYSID_FLAG += --timestamp=1728871358
ELF_PATCH_FLAG  += --timestamp 1728871358
