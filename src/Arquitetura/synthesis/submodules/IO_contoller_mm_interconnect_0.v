// IO_contoller_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module IO_contoller_mm_interconnect_0 (
		input  wire        clk_0_clk_clk,                                  //                                clk_0_clk.clk
		input  wire        nios2_gen2_0_reset_reset_bridge_in_reset_reset, // nios2_gen2_0_reset_reset_bridge_in_reset.reset
		input  wire        rd_data_lsb_reset_reset_bridge_in_reset_reset,  //  rd_data_lsb_reset_reset_bridge_in_reset.reset
		...
		output wire [1:0]  irq_s1_address,                                 //                                   irq_s1.address
		output wire        irq_s1_write,                                   //                                         .write
		input  wire [31:0] irq_s1_readdata,                                //                                         .readdata
		output wire [31:0] irq_s1_writedata,                               //                                         .writedata
		output wire        irq_s1_chipselect,                              //                                         .chipselect
		...
		output wire [1:0]  rd_data_lsb_s1_address,                         //                           rd_data_lsb_s1.address
		input  wire [31:0] rd_data_lsb_s1_readdata,                        //                                         .readdata
		output wire [1:0]  rd_data_msb_s1_address,                         //                           rd_data_msb_s1.address
		input  wire [31:0] rd_data_msb_s1_readdata,                        //                                         .readdata
		output wire [1:0]  we_s1_address,                                  //                                    we_s1.address
		output wire        we_s1_write,                                    //                                         .write
		input  wire [31:0] we_s1_readdata,                                 //                                         .readdata
		output wire [31:0] we_s1_writedata,                                //                                         .writedata
		output wire        we_s1_chipselect,                               //                                         .chipselect
		output wire [1:0]  we_data_lsb_s1_address,                         //                           we_data_lsb_s1.address
		output wire        we_data_lsb_s1_write,                           //                                         .write
		input  wire [31:0] we_data_lsb_s1_readdata,                        //                                         .readdata
		output wire [31:0] we_data_lsb_s1_writedata,                       //                                         .writedata
		output wire        we_data_lsb_s1_chipselect,                      //                                         .chipselect
		output wire [1:0]  we_data_msb_s1_address,                         //                           we_data_msb_s1.address
		output wire        we_data_msb_s1_write,                           //                                         .write
		input  wire [31:0] we_data_msb_s1_readdata,                        //                                         .readdata
		output wire [31:0] we_data_msb_s1_writedata,                       //                                         .writedata
		output wire        we_data_msb_s1_chipselect                       //                                         .chipselect
	);
	...
	wire  [31:0] rd_data_lsb_s1_agent_m0_readdata;                                                   // rd_data_lsb_s1_translator:uav_readdata -> rd_data_lsb_s1_agent:m0_readdata
	wire         rd_data_lsb_s1_agent_m0_waitrequest;                                                // rd_data_lsb_s1_translator:uav_waitrequest -> rd_data_lsb_s1_agent:m0_waitrequest
	wire         rd_data_lsb_s1_agent_m0_debugaccess;                                                // rd_data_lsb_s1_agent:m0_debugaccess -> rd_data_lsb_s1_translator:uav_debugaccess
	wire  [13:0] rd_data_lsb_s1_agent_m0_address;                                                    // rd_data_lsb_s1_agent:m0_address -> rd_data_lsb_s1_translator:uav_address
	wire   [3:0] rd_data_lsb_s1_agent_m0_byteenable;                                                 // rd_data_lsb_s1_agent:m0_byteenable -> rd_data_lsb_s1_translator:uav_byteenable
	wire         rd_data_lsb_s1_agent_m0_read;                                                       // rd_data_lsb_s1_agent:m0_read -> rd_data_lsb_s1_translator:uav_read
	wire         rd_data_lsb_s1_agent_m0_readdatavalid;                                              // rd_data_lsb_s1_translator:uav_readdatavalid -> rd_data_lsb_s1_agent:m0_readdatavalid
	wire         rd_data_lsb_s1_agent_m0_lock;                                                       // rd_data_lsb_s1_agent:m0_lock -> rd_data_lsb_s1_translator:uav_lock
	wire  [31:0] rd_data_lsb_s1_agent_m0_writedata;                                                  // rd_data_lsb_s1_agent:m0_writedata -> rd_data_lsb_s1_translator:uav_writedata
	wire         rd_data_lsb_s1_agent_m0_write;                                                      // rd_data_lsb_s1_agent:m0_write -> rd_data_lsb_s1_translator:uav_write
	wire   [2:0] rd_data_lsb_s1_agent_m0_burstcount;                                                 // rd_data_lsb_s1_agent:m0_burstcount -> rd_data_lsb_s1_translator:uav_burstcount
	wire         rd_data_lsb_s1_agent_rf_source_valid;                                               // rd_data_lsb_s1_agent:rf_source_valid -> rd_data_lsb_s1_agent_rsp_fifo:in_valid
	wire  [92:0] rd_data_lsb_s1_agent_rf_source_data;                                                // rd_data_lsb_s1_agent:rf_source_data -> rd_data_lsb_s1_agent_rsp_fifo:in_data
	wire         rd_data_lsb_s1_agent_rf_source_ready;                                               // rd_data_lsb_s1_agent_rsp_fifo:in_ready -> rd_data_lsb_s1_agent:rf_source_ready
	wire         rd_data_lsb_s1_agent_rf_source_startofpacket;                                       // rd_data_lsb_s1_agent:rf_source_startofpacket -> rd_data_lsb_s1_agent_rsp_fifo:in_startofpacket
	wire         rd_data_lsb_s1_agent_rf_source_endofpacket;                                         // rd_data_lsb_s1_agent:rf_source_endofpacket -> rd_data_lsb_s1_agent_rsp_fifo:in_endofpacket
	wire         rd_data_lsb_s1_agent_rsp_fifo_out_valid;                                            // rd_data_lsb_s1_agent_rsp_fifo:out_valid -> rd_data_lsb_s1_agent:rf_sink_valid
	wire  [92:0] rd_data_lsb_s1_agent_rsp_fifo_out_data;                                             // rd_data_lsb_s1_agent_rsp_fifo:out_data -> rd_data_lsb_s1_agent:rf_sink_data
	wire         rd_data_lsb_s1_agent_rsp_fifo_out_ready;                                            // rd_data_lsb_s1_agent:rf_sink_ready -> rd_data_lsb_s1_agent_rsp_fifo:out_ready
	wire         rd_data_lsb_s1_agent_rsp_fifo_out_startofpacket;                                    // rd_data_lsb_s1_agent_rsp_fifo:out_startofpacket -> rd_data_lsb_s1_agent:rf_sink_startofpacket
	wire         rd_data_lsb_s1_agent_rsp_fifo_out_endofpacket;                                      // rd_data_lsb_s1_agent_rsp_fifo:out_endofpacket -> rd_data_lsb_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> rd_data_lsb_s1_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> rd_data_lsb_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // rd_data_lsb_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [8:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> rd_data_lsb_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> rd_data_lsb_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> rd_data_lsb_s1_agent:cp_endofpacket
	wire  [31:0] rd_data_msb_s1_agent_m0_readdata;                                                   // rd_data_msb_s1_translator:uav_readdata -> rd_data_msb_s1_agent:m0_readdata
	wire         rd_data_msb_s1_agent_m0_waitrequest;                                                // rd_data_msb_s1_translator:uav_waitrequest -> rd_data_msb_s1_agent:m0_waitrequest
	wire         rd_data_msb_s1_agent_m0_debugaccess;                                                // rd_data_msb_s1_agent:m0_debugaccess -> rd_data_msb_s1_translator:uav_debugaccess
	wire  [13:0] rd_data_msb_s1_agent_m0_address;                                                    // rd_data_msb_s1_agent:m0_address -> rd_data_msb_s1_translator:uav_address
	wire   [3:0] rd_data_msb_s1_agent_m0_byteenable;                                                 // rd_data_msb_s1_agent:m0_byteenable -> rd_data_msb_s1_translator:uav_byteenable
	wire         rd_data_msb_s1_agent_m0_read;                                                       // rd_data_msb_s1_agent:m0_read -> rd_data_msb_s1_translator:uav_read
	wire         rd_data_msb_s1_agent_m0_readdatavalid;                                              // rd_data_msb_s1_translator:uav_readdatavalid -> rd_data_msb_s1_agent:m0_readdatavalid
	wire         rd_data_msb_s1_agent_m0_lock;                                                       // rd_data_msb_s1_agent:m0_lock -> rd_data_msb_s1_translator:uav_lock
	wire  [31:0] rd_data_msb_s1_agent_m0_writedata;                                                  // rd_data_msb_s1_agent:m0_writedata -> rd_data_msb_s1_translator:uav_writedata
	wire         rd_data_msb_s1_agent_m0_write;                                                      // rd_data_msb_s1_agent:m0_write -> rd_data_msb_s1_translator:uav_write
	wire   [2:0] rd_data_msb_s1_agent_m0_burstcount;                                                 // rd_data_msb_s1_agent:m0_burstcount -> rd_data_msb_s1_translator:uav_burstcount
	wire         rd_data_msb_s1_agent_rf_source_valid;                                               // rd_data_msb_s1_agent:rf_source_valid -> rd_data_msb_s1_agent_rsp_fifo:in_valid
	wire  [92:0] rd_data_msb_s1_agent_rf_source_data;                                                // rd_data_msb_s1_agent:rf_source_data -> rd_data_msb_s1_agent_rsp_fifo:in_data
	wire         rd_data_msb_s1_agent_rf_source_ready;                                               // rd_data_msb_s1_agent_rsp_fifo:in_ready -> rd_data_msb_s1_agent:rf_source_ready
	wire         rd_data_msb_s1_agent_rf_source_startofpacket;                                       // rd_data_msb_s1_agent:rf_source_startofpacket -> rd_data_msb_s1_agent_rsp_fifo:in_startofpacket
	wire         rd_data_msb_s1_agent_rf_source_endofpacket;                                         // rd_data_msb_s1_agent:rf_source_endofpacket -> rd_data_msb_s1_agent_rsp_fifo:in_endofpacket
	wire         rd_data_msb_s1_agent_rsp_fifo_out_valid;                                            // rd_data_msb_s1_agent_rsp_fifo:out_valid -> rd_data_msb_s1_agent:rf_sink_valid
	wire  [92:0] rd_data_msb_s1_agent_rsp_fifo_out_data;                                             // rd_data_msb_s1_agent_rsp_fifo:out_data -> rd_data_msb_s1_agent:rf_sink_data
	wire         rd_data_msb_s1_agent_rsp_fifo_out_ready;                                            // rd_data_msb_s1_agent:rf_sink_ready -> rd_data_msb_s1_agent_rsp_fifo:out_ready
	wire         rd_data_msb_s1_agent_rsp_fifo_out_startofpacket;                                    // rd_data_msb_s1_agent_rsp_fifo:out_startofpacket -> rd_data_msb_s1_agent:rf_sink_startofpacket
	wire         rd_data_msb_s1_agent_rsp_fifo_out_endofpacket;                                      // rd_data_msb_s1_agent_rsp_fifo:out_endofpacket -> rd_data_msb_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> rd_data_msb_s1_agent:cp_valid
	wire  [91:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> rd_data_msb_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // rd_data_msb_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> rd_data_msb_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> rd_data_msb_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> rd_data_msb_s1_agent:cp_endofpacket
	wire  [31:0] we_data_lsb_s1_agent_m0_readdata;                                                   // we_data_lsb_s1_translator:uav_readdata -> we_data_lsb_s1_agent:m0_readdata
	wire         we_data_lsb_s1_agent_m0_waitrequest;                                                // we_data_lsb_s1_translator:uav_waitrequest -> we_data_lsb_s1_agent:m0_waitrequest
	wire         we_data_lsb_s1_agent_m0_debugaccess;                                                // we_data_lsb_s1_agent:m0_debugaccess -> we_data_lsb_s1_translator:uav_debugaccess
	wire  [13:0] we_data_lsb_s1_agent_m0_address;                                                    // we_data_lsb_s1_agent:m0_address -> we_data_lsb_s1_translator:uav_address
	wire   [3:0] we_data_lsb_s1_agent_m0_byteenable;                                                 // we_data_lsb_s1_agent:m0_byteenable -> we_data_lsb_s1_translator:uav_byteenable
	wire         we_data_lsb_s1_agent_m0_read;                                                       // we_data_lsb_s1_agent:m0_read -> we_data_lsb_s1_translator:uav_read
	wire         we_data_lsb_s1_agent_m0_readdatavalid;                                              // we_data_lsb_s1_translator:uav_readdatavalid -> we_data_lsb_s1_agent:m0_readdatavalid
	wire         we_data_lsb_s1_agent_m0_lock;                                                       // we_data_lsb_s1_agent:m0_lock -> we_data_lsb_s1_translator:uav_lock
	wire  [31:0] we_data_lsb_s1_agent_m0_writedata;                                                  // we_data_lsb_s1_agent:m0_writedata -> we_data_lsb_s1_translator:uav_writedata
	wire         we_data_lsb_s1_agent_m0_write;                                                      // we_data_lsb_s1_agent:m0_write -> we_data_lsb_s1_translator:uav_write
	wire   [2:0] we_data_lsb_s1_agent_m0_burstcount;                                                 // we_data_lsb_s1_agent:m0_burstcount -> we_data_lsb_s1_translator:uav_burstcount
	wire         we_data_lsb_s1_agent_rf_source_valid;                                               // we_data_lsb_s1_agent:rf_source_valid -> we_data_lsb_s1_agent_rsp_fifo:in_valid
	wire  [92:0] we_data_lsb_s1_agent_rf_source_data;                                                // we_data_lsb_s1_agent:rf_source_data -> we_data_lsb_s1_agent_rsp_fifo:in_data
	wire         we_data_lsb_s1_agent_rf_source_ready;                                               // we_data_lsb_s1_agent_rsp_fifo:in_ready -> we_data_lsb_s1_agent:rf_source_ready
	wire         we_data_lsb_s1_agent_rf_source_startofpacket;                                       // we_data_lsb_s1_agent:rf_source_startofpacket -> we_data_lsb_s1_agent_rsp_fifo:in_startofpacket
	wire         we_data_lsb_s1_agent_rf_source_endofpacket;                                         // we_data_lsb_s1_agent:rf_source_endofpacket -> we_data_lsb_s1_agent_rsp_fifo:in_endofpacket
	wire         we_data_lsb_s1_agent_rsp_fifo_out_valid;                                            // we_data_lsb_s1_agent_rsp_fifo:out_valid -> we_data_lsb_s1_agent:rf_sink_valid
	wire  [92:0] we_data_lsb_s1_agent_rsp_fifo_out_data;                                             // we_data_lsb_s1_agent_rsp_fifo:out_data -> we_data_lsb_s1_agent:rf_sink_data
	wire         we_data_lsb_s1_agent_rsp_fifo_out_ready;                                            // we_data_lsb_s1_agent:rf_sink_ready -> we_data_lsb_s1_agent_rsp_fifo:out_ready
	wire         we_data_lsb_s1_agent_rsp_fifo_out_startofpacket;                                    // we_data_lsb_s1_agent_rsp_fifo:out_startofpacket -> we_data_lsb_s1_agent:rf_sink_startofpacket
	wire         we_data_lsb_s1_agent_rsp_fifo_out_endofpacket;                                      // we_data_lsb_s1_agent_rsp_fifo:out_endofpacket -> we_data_lsb_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> we_data_lsb_s1_agent:cp_valid
	wire  [91:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> we_data_lsb_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // we_data_lsb_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> we_data_lsb_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> we_data_lsb_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> we_data_lsb_s1_agent:cp_endofpacket
	wire  [31:0] we_data_msb_s1_agent_m0_readdata;                                                   // we_data_msb_s1_translator:uav_readdata -> we_data_msb_s1_agent:m0_readdata
	wire         we_data_msb_s1_agent_m0_waitrequest;                                                // we_data_msb_s1_translator:uav_waitrequest -> we_data_msb_s1_agent:m0_waitrequest
	wire         we_data_msb_s1_agent_m0_debugaccess;                                                // we_data_msb_s1_agent:m0_debugaccess -> we_data_msb_s1_translator:uav_debugaccess
	wire  [13:0] we_data_msb_s1_agent_m0_address;                                                    // we_data_msb_s1_agent:m0_address -> we_data_msb_s1_translator:uav_address
	wire   [3:0] we_data_msb_s1_agent_m0_byteenable;                                                 // we_data_msb_s1_agent:m0_byteenable -> we_data_msb_s1_translator:uav_byteenable
	wire         we_data_msb_s1_agent_m0_read;                                                       // we_data_msb_s1_agent:m0_read -> we_data_msb_s1_translator:uav_read
	wire         we_data_msb_s1_agent_m0_readdatavalid;                                              // we_data_msb_s1_translator:uav_readdatavalid -> we_data_msb_s1_agent:m0_readdatavalid
	wire         we_data_msb_s1_agent_m0_lock;                                                       // we_data_msb_s1_agent:m0_lock -> we_data_msb_s1_translator:uav_lock
	wire  [31:0] we_data_msb_s1_agent_m0_writedata;                                                  // we_data_msb_s1_agent:m0_writedata -> we_data_msb_s1_translator:uav_writedata
	wire         we_data_msb_s1_agent_m0_write;                                                      // we_data_msb_s1_agent:m0_write -> we_data_msb_s1_translator:uav_write
	wire   [2:0] we_data_msb_s1_agent_m0_burstcount;                                                 // we_data_msb_s1_agent:m0_burstcount -> we_data_msb_s1_translator:uav_burstcount
	wire         we_data_msb_s1_agent_rf_source_valid;                                               // we_data_msb_s1_agent:rf_source_valid -> we_data_msb_s1_agent_rsp_fifo:in_valid
	wire  [92:0] we_data_msb_s1_agent_rf_source_data;                                                // we_data_msb_s1_agent:rf_source_data -> we_data_msb_s1_agent_rsp_fifo:in_data
	wire         we_data_msb_s1_agent_rf_source_ready;                                               // we_data_msb_s1_agent_rsp_fifo:in_ready -> we_data_msb_s1_agent:rf_source_ready
	wire         we_data_msb_s1_agent_rf_source_startofpacket;                                       // we_data_msb_s1_agent:rf_source_startofpacket -> we_data_msb_s1_agent_rsp_fifo:in_startofpacket
	wire         we_data_msb_s1_agent_rf_source_endofpacket;                                         // we_data_msb_s1_agent:rf_source_endofpacket -> we_data_msb_s1_agent_rsp_fifo:in_endofpacket
	wire         we_data_msb_s1_agent_rsp_fifo_out_valid;                                            // we_data_msb_s1_agent_rsp_fifo:out_valid -> we_data_msb_s1_agent:rf_sink_valid
	wire  [92:0] we_data_msb_s1_agent_rsp_fifo_out_data;                                             // we_data_msb_s1_agent_rsp_fifo:out_data -> we_data_msb_s1_agent:rf_sink_data
	wire         we_data_msb_s1_agent_rsp_fifo_out_ready;                                            // we_data_msb_s1_agent:rf_sink_ready -> we_data_msb_s1_agent_rsp_fifo:out_ready
	wire         we_data_msb_s1_agent_rsp_fifo_out_startofpacket;                                    // we_data_msb_s1_agent_rsp_fifo:out_startofpacket -> we_data_msb_s1_agent:rf_sink_startofpacket
	wire         we_data_msb_s1_agent_rsp_fifo_out_endofpacket;                                      // we_data_msb_s1_agent_rsp_fifo:out_endofpacket -> we_data_msb_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> we_data_msb_s1_agent:cp_valid
	wire  [91:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> we_data_msb_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // we_data_msb_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> we_data_msb_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> we_data_msb_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> we_data_msb_s1_agent:cp_endofpacket
	wire  [31:0] we_s1_agent_m0_readdata;                                                            // we_s1_translator:uav_readdata -> we_s1_agent:m0_readdata
	wire         we_s1_agent_m0_waitrequest;                                                         // we_s1_translator:uav_waitrequest -> we_s1_agent:m0_waitrequest
	wire         we_s1_agent_m0_debugaccess;                                                         // we_s1_agent:m0_debugaccess -> we_s1_translator:uav_debugaccess
	wire  [13:0] we_s1_agent_m0_address;                                                             // we_s1_agent:m0_address -> we_s1_translator:uav_address
	wire   [3:0] we_s1_agent_m0_byteenable;                                                          // we_s1_agent:m0_byteenable -> we_s1_translator:uav_byteenable
	wire         we_s1_agent_m0_read;                                                                // we_s1_agent:m0_read -> we_s1_translator:uav_read
	wire         we_s1_agent_m0_readdatavalid;                                                       // we_s1_translator:uav_readdatavalid -> we_s1_agent:m0_readdatavalid
	wire         we_s1_agent_m0_lock;                                                                // we_s1_agent:m0_lock -> we_s1_translator:uav_lock
	wire  [31:0] we_s1_agent_m0_writedata;                                                           // we_s1_agent:m0_writedata -> we_s1_translator:uav_writedata
	wire         we_s1_agent_m0_write;                                                               // we_s1_agent:m0_write -> we_s1_translator:uav_write
	wire   [2:0] we_s1_agent_m0_burstcount;                                                          // we_s1_agent:m0_burstcount -> we_s1_translator:uav_burstcount
	wire         we_s1_agent_rf_source_valid;                                                        // we_s1_agent:rf_source_valid -> we_s1_agent_rsp_fifo:in_valid
	wire  [92:0] we_s1_agent_rf_source_data;                                                         // we_s1_agent:rf_source_data -> we_s1_agent_rsp_fifo:in_data
	wire         we_s1_agent_rf_source_ready;                                                        // we_s1_agent_rsp_fifo:in_ready -> we_s1_agent:rf_source_ready
	wire         we_s1_agent_rf_source_startofpacket;                                                // we_s1_agent:rf_source_startofpacket -> we_s1_agent_rsp_fifo:in_startofpacket
	wire         we_s1_agent_rf_source_endofpacket;                                                  // we_s1_agent:rf_source_endofpacket -> we_s1_agent_rsp_fifo:in_endofpacket
	wire         we_s1_agent_rsp_fifo_out_valid;                                                     // we_s1_agent_rsp_fifo:out_valid -> we_s1_agent:rf_sink_valid
	wire  [92:0] we_s1_agent_rsp_fifo_out_data;                                                      // we_s1_agent_rsp_fifo:out_data -> we_s1_agent:rf_sink_data
	wire         we_s1_agent_rsp_fifo_out_ready;                                                     // we_s1_agent:rf_sink_ready -> we_s1_agent_rsp_fifo:out_ready
	wire         we_s1_agent_rsp_fifo_out_startofpacket;                                             // we_s1_agent_rsp_fifo:out_startofpacket -> we_s1_agent:rf_sink_startofpacket
	wire         we_s1_agent_rsp_fifo_out_endofpacket;                                               // we_s1_agent_rsp_fifo:out_endofpacket -> we_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> we_s1_agent:cp_valid
	wire  [91:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> we_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // we_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> we_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> we_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> we_s1_agent:cp_endofpacket
	wire  [31:0] irq_s1_agent_m0_readdata;                                                           // irq_s1_translator:uav_readdata -> irq_s1_agent:m0_readdata
	wire         irq_s1_agent_m0_waitrequest;                                                        // irq_s1_translator:uav_waitrequest -> irq_s1_agent:m0_waitrequest
	wire         irq_s1_agent_m0_debugaccess;                                                        // irq_s1_agent:m0_debugaccess -> irq_s1_translator:uav_debugaccess
	wire  [13:0] irq_s1_agent_m0_address;                                                            // irq_s1_agent:m0_address -> irq_s1_translator:uav_address
	wire   [3:0] irq_s1_agent_m0_byteenable;                                                         // irq_s1_agent:m0_byteenable -> irq_s1_translator:uav_byteenable
	wire         irq_s1_agent_m0_read;                                                               // irq_s1_agent:m0_read -> irq_s1_translator:uav_read
	wire         irq_s1_agent_m0_readdatavalid;                                                      // irq_s1_translator:uav_readdatavalid -> irq_s1_agent:m0_readdatavalid
	wire         irq_s1_agent_m0_lock;                                                               // irq_s1_agent:m0_lock -> irq_s1_translator:uav_lock
	wire  [31:0] irq_s1_agent_m0_writedata;                                                          // irq_s1_agent:m0_writedata -> irq_s1_translator:uav_writedata
	wire         irq_s1_agent_m0_write;                                                              // irq_s1_agent:m0_write -> irq_s1_translator:uav_write
	wire   [2:0] irq_s1_agent_m0_burstcount;                                                         // irq_s1_agent:m0_burstcount -> irq_s1_translator:uav_burstcount
	wire         irq_s1_agent_rf_source_valid;                                                       // irq_s1_agent:rf_source_valid -> irq_s1_agent_rsp_fifo:in_valid
	wire  [92:0] irq_s1_agent_rf_source_data;                                                        // irq_s1_agent:rf_source_data -> irq_s1_agent_rsp_fifo:in_data
	wire         irq_s1_agent_rf_source_ready;                                                       // irq_s1_agent_rsp_fifo:in_ready -> irq_s1_agent:rf_source_ready
	wire         irq_s1_agent_rf_source_startofpacket;                                               // irq_s1_agent:rf_source_startofpacket -> irq_s1_agent_rsp_fifo:in_startofpacket
	wire         irq_s1_agent_rf_source_endofpacket;                                                 // irq_s1_agent:rf_source_endofpacket -> irq_s1_agent_rsp_fifo:in_endofpacket
	wire         irq_s1_agent_rsp_fifo_out_valid;                                                    // irq_s1_agent_rsp_fifo:out_valid -> irq_s1_agent:rf_sink_valid
	wire  [92:0] irq_s1_agent_rsp_fifo_out_data;                                                     // irq_s1_agent_rsp_fifo:out_data -> irq_s1_agent:rf_sink_data
	wire         irq_s1_agent_rsp_fifo_out_ready;                                                    // irq_s1_agent:rf_sink_ready -> irq_s1_agent_rsp_fifo:out_ready
	wire         irq_s1_agent_rsp_fifo_out_startofpacket;                                            // irq_s1_agent_rsp_fifo:out_startofpacket -> irq_s1_agent:rf_sink_startofpacket
	wire         irq_s1_agent_rsp_fifo_out_endofpacket;                                              // irq_s1_agent_rsp_fifo:out_endofpacket -> irq_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> irq_s1_agent:cp_valid
	wire  [91:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> irq_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                              // irq_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> irq_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> irq_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> irq_s1_agent:cp_endofpacket
	...
	wire         rd_data_lsb_s1_agent_rp_valid;                                                      // rd_data_lsb_s1_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] rd_data_lsb_s1_agent_rp_data;                                                       // rd_data_lsb_s1_agent:rp_data -> router_005:sink_data
	wire         rd_data_lsb_s1_agent_rp_ready;                                                      // router_005:sink_ready -> rd_data_lsb_s1_agent:rp_ready
	wire         rd_data_lsb_s1_agent_rp_startofpacket;                                              // rd_data_lsb_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         rd_data_lsb_s1_agent_rp_endofpacket;                                                // rd_data_lsb_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         rd_data_msb_s1_agent_rp_valid;                                                      // rd_data_msb_s1_agent:rp_valid -> router_006:sink_valid
	wire  [91:0] rd_data_msb_s1_agent_rp_data;                                                       // rd_data_msb_s1_agent:rp_data -> router_006:sink_data
	wire         rd_data_msb_s1_agent_rp_ready;                                                      // router_006:sink_ready -> rd_data_msb_s1_agent:rp_ready
	wire         rd_data_msb_s1_agent_rp_startofpacket;                                              // rd_data_msb_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         rd_data_msb_s1_agent_rp_endofpacket;                                                // rd_data_msb_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         we_data_lsb_s1_agent_rp_valid;                                                      // we_data_lsb_s1_agent:rp_valid -> router_007:sink_valid
	wire  [91:0] we_data_lsb_s1_agent_rp_data;                                                       // we_data_lsb_s1_agent:rp_data -> router_007:sink_data
	wire         we_data_lsb_s1_agent_rp_ready;                                                      // router_007:sink_ready -> we_data_lsb_s1_agent:rp_ready
	wire         we_data_lsb_s1_agent_rp_startofpacket;                                              // we_data_lsb_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         we_data_lsb_s1_agent_rp_endofpacket;                                                // we_data_lsb_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         we_data_msb_s1_agent_rp_valid;                                                      // we_data_msb_s1_agent:rp_valid -> router_008:sink_valid
	wire  [91:0] we_data_msb_s1_agent_rp_data;                                                       // we_data_msb_s1_agent:rp_data -> router_008:sink_data
	wire         we_data_msb_s1_agent_rp_ready;                                                      // router_008:sink_ready -> we_data_msb_s1_agent:rp_ready
	wire         we_data_msb_s1_agent_rp_startofpacket;                                              // we_data_msb_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         we_data_msb_s1_agent_rp_endofpacket;                                                // we_data_msb_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         we_s1_agent_rp_valid;                                                               // we_s1_agent:rp_valid -> router_009:sink_valid
	wire  [91:0] we_s1_agent_rp_data;                                                                // we_s1_agent:rp_data -> router_009:sink_data
	wire         we_s1_agent_rp_ready;                                                               // router_009:sink_ready -> we_s1_agent:rp_ready
	wire         we_s1_agent_rp_startofpacket;                                                       // we_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         we_s1_agent_rp_endofpacket;                                                         // we_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         irq_s1_agent_rp_valid;                                                              // irq_s1_agent:rp_valid -> router_010:sink_valid
	wire  [91:0] irq_s1_agent_rp_data;                                                               // irq_s1_agent:rp_data -> router_010:sink_data
	wire         irq_s1_agent_rp_ready;                                                              // router_010:sink_ready -> irq_s1_agent:rp_ready
	wire         irq_s1_agent_rp_startofpacket;                                                      // irq_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         irq_s1_agent_rp_endofpacket;                                                        // irq_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         rd_data_lsb_s1_agent_rdata_fifo_src_valid;                                          // rd_data_lsb_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] rd_data_lsb_s1_agent_rdata_fifo_src_data;                                           // rd_data_lsb_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         rd_data_lsb_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_003:in_0_ready -> rd_data_lsb_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> rd_data_lsb_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> rd_data_lsb_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // rd_data_lsb_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> rd_data_lsb_s1_agent:rdata_fifo_sink_error
	wire         rd_data_msb_s1_agent_rdata_fifo_src_valid;                                          // rd_data_msb_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] rd_data_msb_s1_agent_rdata_fifo_src_data;                                           // rd_data_msb_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         rd_data_msb_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_004:in_0_ready -> rd_data_msb_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> rd_data_msb_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> rd_data_msb_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // rd_data_msb_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> rd_data_msb_s1_agent:rdata_fifo_sink_error
	wire         we_data_lsb_s1_agent_rdata_fifo_src_valid;                                          // we_data_lsb_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] we_data_lsb_s1_agent_rdata_fifo_src_data;                                           // we_data_lsb_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         we_data_lsb_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_005:in_0_ready -> we_data_lsb_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> we_data_lsb_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> we_data_lsb_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // we_data_lsb_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> we_data_lsb_s1_agent:rdata_fifo_sink_error
	wire         we_data_msb_s1_agent_rdata_fifo_src_valid;                                          // we_data_msb_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] we_data_msb_s1_agent_rdata_fifo_src_data;                                           // we_data_msb_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         we_data_msb_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_006:in_0_ready -> we_data_msb_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> we_data_msb_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> we_data_msb_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // we_data_msb_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> we_data_msb_s1_agent:rdata_fifo_sink_error
	wire         we_s1_agent_rdata_fifo_src_valid;                                                   // we_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] we_s1_agent_rdata_fifo_src_data;                                                    // we_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         we_s1_agent_rdata_fifo_src_ready;                                                   // avalon_st_adapter_007:in_0_ready -> we_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> we_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> we_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // we_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> we_s1_agent:rdata_fifo_sink_error
	wire         irq_s1_agent_rdata_fifo_src_valid;                                                  // irq_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] irq_s1_agent_rdata_fifo_src_data;                                                   // irq_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         irq_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_008:in_0_ready -> irq_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> irq_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> irq_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                                  // irq_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> irq_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) rd_data_lsb_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (rd_data_lsb_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (rd_data_lsb_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (rd_data_lsb_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (rd_data_lsb_s1_agent_m0_read),                  //                         .read
		.uav_write              (rd_data_lsb_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (rd_data_lsb_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (rd_data_lsb_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (rd_data_lsb_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (rd_data_lsb_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (rd_data_lsb_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (rd_data_lsb_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (rd_data_lsb_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (rd_data_lsb_s1_address),                        //      avalon_anti_slave_0.address
		.av_readdata            (rd_data_lsb_s1_readdata),                       //                         .readdata
		.av_write               (),                                              //              (terminated)
		.av_read                (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) rd_data_msb_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (rd_data_lsb_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (rd_data_msb_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (rd_data_msb_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (rd_data_msb_s1_agent_m0_read),                  //                         .read
		.uav_write              (rd_data_msb_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (rd_data_msb_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (rd_data_msb_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (rd_data_msb_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (rd_data_msb_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (rd_data_msb_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (rd_data_msb_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (rd_data_msb_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (rd_data_msb_s1_address),                        //      avalon_anti_slave_0.address
		.av_readdata            (rd_data_msb_s1_readdata),                       //                         .readdata
		.av_write               (),                                              //              (terminated)
		.av_read                (),                                              //              (terminated)
		.av_writedata           (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) we_data_lsb_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (rd_data_lsb_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (we_data_lsb_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (we_data_lsb_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (we_data_lsb_s1_agent_m0_read),                  //                         .read
		.uav_write              (we_data_lsb_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (we_data_lsb_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (we_data_lsb_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (we_data_lsb_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (we_data_lsb_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (we_data_lsb_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (we_data_lsb_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (we_data_lsb_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (we_data_lsb_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (we_data_lsb_s1_write),                          //                         .write
		.av_readdata            (we_data_lsb_s1_readdata),                       //                         .readdata
		.av_writedata           (we_data_lsb_s1_writedata),                      //                         .writedata
		.av_chipselect          (we_data_lsb_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) we_data_msb_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (rd_data_lsb_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (we_data_msb_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (we_data_msb_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (we_data_msb_s1_agent_m0_read),                  //                         .read
		.uav_write              (we_data_msb_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (we_data_msb_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (we_data_msb_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (we_data_msb_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (we_data_msb_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (we_data_msb_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (we_data_msb_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (we_data_msb_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (we_data_msb_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (we_data_msb_s1_write),                          //                         .write
		.av_readdata            (we_data_msb_s1_readdata),                       //                         .readdata
		.av_writedata           (we_data_msb_s1_writedata),                      //                         .writedata
		.av_chipselect          (we_data_msb_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (rd_data_lsb_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (we_s1_agent_m0_address),                        // avalon_universal_slave_0.address
		.uav_burstcount         (we_s1_agent_m0_burstcount),                     //                         .burstcount
		.uav_read               (we_s1_agent_m0_read),                           //                         .read
		.uav_write              (we_s1_agent_m0_write),                          //                         .write
		.uav_waitrequest        (we_s1_agent_m0_waitrequest),                    //                         .waitrequest
		.uav_readdatavalid      (we_s1_agent_m0_readdatavalid),                  //                         .readdatavalid
		.uav_byteenable         (we_s1_agent_m0_byteenable),                     //                         .byteenable
		.uav_readdata           (we_s1_agent_m0_readdata),                       //                         .readdata
		.uav_writedata          (we_s1_agent_m0_writedata),                      //                         .writedata
		.uav_lock               (we_s1_agent_m0_lock),                           //                         .lock
		.uav_debugaccess        (we_s1_agent_m0_debugaccess),                    //                         .debugaccess
		.av_address             (we_s1_address),                                 //      avalon_anti_slave_0.address
		.av_write               (we_s1_write),                                   //                         .write
		.av_readdata            (we_s1_readdata),                                //                         .readdata
		.av_writedata           (we_s1_writedata),                               //                         .writedata
		.av_chipselect          (we_s1_chipselect),                              //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (rd_data_lsb_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (irq_s1_agent_m0_address),                       // avalon_universal_slave_0.address
		.uav_burstcount         (irq_s1_agent_m0_burstcount),                    //                         .burstcount
		.uav_read               (irq_s1_agent_m0_read),                          //                         .read
		.uav_write              (irq_s1_agent_m0_write),                         //                         .write
		.uav_waitrequest        (irq_s1_agent_m0_waitrequest),                   //                         .waitrequest
		.uav_readdatavalid      (irq_s1_agent_m0_readdatavalid),                 //                         .readdatavalid
		.uav_byteenable         (irq_s1_agent_m0_byteenable),                    //                         .byteenable
		.uav_readdata           (irq_s1_agent_m0_readdata),                      //                         .readdata
		.uav_writedata          (irq_s1_agent_m0_writedata),                     //                         .writedata
		.uav_lock               (irq_s1_agent_m0_lock),                          //                         .lock
		.uav_debugaccess        (irq_s1_agent_m0_debugaccess),                   //                         .debugaccess
		.av_address             (irq_s1_address),                                //      avalon_anti_slave_0.address
		.av_write               (irq_s1_write),                                  //                         .write
		.av_readdata            (irq_s1_readdata),                               //                         .readdata
		.av_writedata           (irq_s1_writedata),                              //                         .writedata
		.av_chipselect          (irq_s1_chipselect),                             //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) rd_data_lsb_s1_agent (
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (rd_data_lsb_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (rd_data_lsb_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (rd_data_lsb_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (rd_data_lsb_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (rd_data_lsb_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (rd_data_lsb_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (rd_data_lsb_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (rd_data_lsb_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (rd_data_lsb_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (rd_data_lsb_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (rd_data_lsb_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (rd_data_lsb_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (rd_data_lsb_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (rd_data_lsb_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (rd_data_lsb_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (rd_data_lsb_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (rd_data_lsb_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (rd_data_lsb_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (rd_data_lsb_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (rd_data_lsb_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (rd_data_lsb_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (rd_data_lsb_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (rd_data_lsb_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (rd_data_lsb_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (rd_data_lsb_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (rd_data_lsb_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (rd_data_lsb_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),               //                .error
		.rdata_fifo_src_ready    (rd_data_lsb_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (rd_data_lsb_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (rd_data_lsb_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) rd_data_lsb_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                   //       clk.clk
		.reset             (rd_data_lsb_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (rd_data_lsb_s1_agent_rf_source_data),             //        in.data
		.in_valid          (rd_data_lsb_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (rd_data_lsb_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (rd_data_lsb_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (rd_data_lsb_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (rd_data_lsb_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (rd_data_lsb_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (rd_data_lsb_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (rd_data_lsb_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (rd_data_lsb_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) rd_data_msb_s1_agent (
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (rd_data_lsb_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (rd_data_msb_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (rd_data_msb_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (rd_data_msb_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (rd_data_msb_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (rd_data_msb_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (rd_data_msb_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (rd_data_msb_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (rd_data_msb_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (rd_data_msb_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (rd_data_msb_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (rd_data_msb_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (rd_data_msb_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (rd_data_msb_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (rd_data_msb_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (rd_data_msb_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (rd_data_msb_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (rd_data_msb_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (rd_data_msb_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (rd_data_msb_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (rd_data_msb_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (rd_data_msb_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (rd_data_msb_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (rd_data_msb_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (rd_data_msb_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (rd_data_msb_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (rd_data_msb_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),               //                .error
		.rdata_fifo_src_ready    (rd_data_msb_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (rd_data_msb_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (rd_data_msb_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) rd_data_msb_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                   //       clk.clk
		.reset             (rd_data_lsb_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (rd_data_msb_s1_agent_rf_source_data),             //        in.data
		.in_valid          (rd_data_msb_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (rd_data_msb_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (rd_data_msb_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (rd_data_msb_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (rd_data_msb_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (rd_data_msb_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (rd_data_msb_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (rd_data_msb_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (rd_data_msb_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) we_data_lsb_s1_agent (
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (rd_data_lsb_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (we_data_lsb_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (we_data_lsb_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (we_data_lsb_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (we_data_lsb_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (we_data_lsb_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (we_data_lsb_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (we_data_lsb_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (we_data_lsb_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (we_data_lsb_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (we_data_lsb_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (we_data_lsb_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (we_data_lsb_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (we_data_lsb_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (we_data_lsb_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (we_data_lsb_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (we_data_lsb_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (we_data_lsb_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (we_data_lsb_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (we_data_lsb_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (we_data_lsb_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (we_data_lsb_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (we_data_lsb_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (we_data_lsb_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (we_data_lsb_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (we_data_lsb_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (we_data_lsb_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),               //                .error
		.rdata_fifo_src_ready    (we_data_lsb_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (we_data_lsb_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (we_data_lsb_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) we_data_lsb_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                   //       clk.clk
		.reset             (rd_data_lsb_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (we_data_lsb_s1_agent_rf_source_data),             //        in.data
		.in_valid          (we_data_lsb_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (we_data_lsb_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (we_data_lsb_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (we_data_lsb_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (we_data_lsb_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (we_data_lsb_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (we_data_lsb_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (we_data_lsb_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (we_data_lsb_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) we_data_msb_s1_agent (
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (rd_data_lsb_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (we_data_msb_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (we_data_msb_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (we_data_msb_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (we_data_msb_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (we_data_msb_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (we_data_msb_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (we_data_msb_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (we_data_msb_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (we_data_msb_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (we_data_msb_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (we_data_msb_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (we_data_msb_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (we_data_msb_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (we_data_msb_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (we_data_msb_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (we_data_msb_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (we_data_msb_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (we_data_msb_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (we_data_msb_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (we_data_msb_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (we_data_msb_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (we_data_msb_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (we_data_msb_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (we_data_msb_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (we_data_msb_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (we_data_msb_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),               //                .error
		.rdata_fifo_src_ready    (we_data_msb_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (we_data_msb_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (we_data_msb_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) we_data_msb_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                   //       clk.clk
		.reset             (rd_data_lsb_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (we_data_msb_s1_agent_rf_source_data),             //        in.data
		.in_valid          (we_data_msb_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (we_data_msb_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (we_data_msb_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (we_data_msb_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (we_data_msb_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (we_data_msb_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (we_data_msb_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (we_data_msb_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (we_data_msb_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (rd_data_lsb_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (we_s1_agent_m0_address),                        //              m0.address
		.m0_burstcount           (we_s1_agent_m0_burstcount),                     //                .burstcount
		.m0_byteenable           (we_s1_agent_m0_byteenable),                     //                .byteenable
		.m0_debugaccess          (we_s1_agent_m0_debugaccess),                    //                .debugaccess
		.m0_lock                 (we_s1_agent_m0_lock),                           //                .lock
		.m0_readdata             (we_s1_agent_m0_readdata),                       //                .readdata
		.m0_readdatavalid        (we_s1_agent_m0_readdatavalid),                  //                .readdatavalid
		.m0_read                 (we_s1_agent_m0_read),                           //                .read
		.m0_waitrequest          (we_s1_agent_m0_waitrequest),                    //                .waitrequest
		.m0_writedata            (we_s1_agent_m0_writedata),                      //                .writedata
		.m0_write                (we_s1_agent_m0_write),                          //                .write
		.rp_endofpacket          (we_s1_agent_rp_endofpacket),                    //              rp.endofpacket
		.rp_ready                (we_s1_agent_rp_ready),                          //                .ready
		.rp_valid                (we_s1_agent_rp_valid),                          //                .valid
		.rp_data                 (we_s1_agent_rp_data),                           //                .data
		.rp_startofpacket        (we_s1_agent_rp_startofpacket),                  //                .startofpacket
		...
		.rf_sink_ready           (we_s1_agent_rsp_fifo_out_ready),                //         rf_sink.ready
		.rf_sink_valid           (we_s1_agent_rsp_fifo_out_valid),                //                .valid
		.rf_sink_startofpacket   (we_s1_agent_rsp_fifo_out_startofpacket),        //                .startofpacket
		.rf_sink_endofpacket     (we_s1_agent_rsp_fifo_out_endofpacket),          //                .endofpacket
		.rf_sink_data            (we_s1_agent_rsp_fifo_out_data),                 //                .data
		.rf_source_ready         (we_s1_agent_rf_source_ready),                   //       rf_source.ready
		.rf_source_valid         (we_s1_agent_rf_source_valid),                   //                .valid
		.rf_source_startofpacket (we_s1_agent_rf_source_startofpacket),           //                .startofpacket
		.rf_source_endofpacket   (we_s1_agent_rf_source_endofpacket),             //                .endofpacket
		.rf_source_data          (we_s1_agent_rf_source_data),                    //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),             //                .error
		.rdata_fifo_src_ready    (we_s1_agent_rdata_fifo_src_ready),              //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (we_s1_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_src_data     (we_s1_agent_rdata_fifo_src_data),               //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) we_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (we_s1_agent_rf_source_data),                    //        in.data
		.in_valid          (we_s1_agent_rf_source_valid),                   //          .valid
		.in_ready          (we_s1_agent_rf_source_ready),                   //          .ready
		.in_startofpacket  (we_s1_agent_rf_source_startofpacket),           //          .startofpacket
		.in_endofpacket    (we_s1_agent_rf_source_endofpacket),             //          .endofpacket
		.out_data          (we_s1_agent_rsp_fifo_out_data),                 //       out.data
		.out_valid         (we_s1_agent_rsp_fifo_out_valid),                //          .valid
		.out_ready         (we_s1_agent_rsp_fifo_out_ready),                //          .ready
		.out_startofpacket (we_s1_agent_rsp_fifo_out_startofpacket),        //          .startofpacket
		.out_endofpacket   (we_s1_agent_rsp_fifo_out_endofpacket),          //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (rd_data_lsb_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (irq_s1_agent_m0_address),                       //              m0.address
		.m0_burstcount           (irq_s1_agent_m0_burstcount),                    //                .burstcount
		.m0_byteenable           (irq_s1_agent_m0_byteenable),                    //                .byteenable
		.m0_debugaccess          (irq_s1_agent_m0_debugaccess),                   //                .debugaccess
		.m0_lock                 (irq_s1_agent_m0_lock),                          //                .lock
		.m0_readdata             (irq_s1_agent_m0_readdata),                      //                .readdata
		.m0_readdatavalid        (irq_s1_agent_m0_readdatavalid),                 //                .readdatavalid
		.m0_read                 (irq_s1_agent_m0_read),                          //                .read
		.m0_waitrequest          (irq_s1_agent_m0_waitrequest),                   //                .waitrequest
		.m0_writedata            (irq_s1_agent_m0_writedata),                     //                .writedata
		.m0_write                (irq_s1_agent_m0_write),                         //                .write
		.rp_endofpacket          (irq_s1_agent_rp_endofpacket),                   //              rp.endofpacket
		.rp_ready                (irq_s1_agent_rp_ready),                         //                .ready
		.rp_valid                (irq_s1_agent_rp_valid),                         //                .valid
		.rp_data                 (irq_s1_agent_rp_data),                          //                .data
		.rp_startofpacket        (irq_s1_agent_rp_startofpacket),                 //                .startofpacket
		...
		.rf_sink_ready           (irq_s1_agent_rsp_fifo_out_ready),               //         rf_sink.ready
		.rf_sink_valid           (irq_s1_agent_rsp_fifo_out_valid),               //                .valid
		.rf_sink_startofpacket   (irq_s1_agent_rsp_fifo_out_startofpacket),       //                .startofpacket
		.rf_sink_endofpacket     (irq_s1_agent_rsp_fifo_out_endofpacket),         //                .endofpacket
		.rf_sink_data            (irq_s1_agent_rsp_fifo_out_data),                //                .data
		.rf_source_ready         (irq_s1_agent_rf_source_ready),                  //       rf_source.ready
		.rf_source_valid         (irq_s1_agent_rf_source_valid),                  //                .valid
		.rf_source_startofpacket (irq_s1_agent_rf_source_startofpacket),          //                .startofpacket
		.rf_source_endofpacket   (irq_s1_agent_rf_source_endofpacket),            //                .endofpacket
		.rf_source_data          (irq_s1_agent_rf_source_data),                   //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),             //                .error
		.rdata_fifo_src_ready    (irq_s1_agent_rdata_fifo_src_ready),             //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (irq_s1_agent_rdata_fifo_src_valid),             //                .valid
		.rdata_fifo_src_data     (irq_s1_agent_rdata_fifo_src_data),              //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) irq_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (irq_s1_agent_rf_source_data),                   //        in.data
		.in_valid          (irq_s1_agent_rf_source_valid),                  //          .valid
		.in_ready          (irq_s1_agent_rf_source_ready),                  //          .ready
		.in_startofpacket  (irq_s1_agent_rf_source_startofpacket),          //          .startofpacket
		.in_endofpacket    (irq_s1_agent_rf_source_endofpacket),            //          .endofpacket
		.out_data          (irq_s1_agent_rsp_fifo_out_data),                //       out.data
		.out_valid         (irq_s1_agent_rsp_fifo_out_valid),               //          .valid
		.out_ready         (irq_s1_agent_rsp_fifo_out_ready),               //          .ready
		.out_startofpacket (irq_s1_agent_rsp_fifo_out_startofpacket),       //          .startofpacket
		.out_endofpacket   (irq_s1_agent_rsp_fifo_out_endofpacket),         //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	IO_contoller_mm_interconnect_0_router router (
	...
	IO_contoller_mm_interconnect_0_router_001 router_001 (
	...
	IO_contoller_mm_interconnect_0_router_002 router_002 (
	...
	IO_contoller_mm_interconnect_0_router_002 router_003 (
	...
	IO_contoller_mm_interconnect_0_router_002 router_004 (
	...
	IO_contoller_mm_interconnect_0_router_005 router_005 (
		.sink_ready         (rd_data_lsb_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (rd_data_lsb_s1_agent_rp_valid),                 //          .valid
		.sink_data          (rd_data_lsb_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (rd_data_lsb_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (rd_data_lsb_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_router_005 router_006 (
		.sink_ready         (rd_data_msb_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (rd_data_msb_s1_agent_rp_valid),                 //          .valid
		.sink_data          (rd_data_msb_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (rd_data_msb_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (rd_data_msb_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_router_005 router_007 (
		.sink_ready         (we_data_lsb_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (we_data_lsb_s1_agent_rp_valid),                 //          .valid
		.sink_data          (we_data_lsb_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (we_data_lsb_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (we_data_lsb_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_router_005 router_008 (
		.sink_ready         (we_data_msb_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (we_data_msb_s1_agent_rp_valid),                 //          .valid
		.sink_data          (we_data_msb_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (we_data_msb_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (we_data_msb_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_router_005 router_009 (
		.sink_ready         (we_s1_agent_rp_ready),                          //      sink.ready
		.sink_valid         (we_s1_agent_rp_valid),                          //          .valid
		.sink_data          (we_s1_agent_rp_data),                           //          .data
		.sink_startofpacket (we_s1_agent_rp_startofpacket),                  //          .startofpacket
		.sink_endofpacket   (we_s1_agent_rp_endofpacket),                    //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_router_005 router_010 (
		.sink_ready         (irq_s1_agent_rp_ready),                         //      sink.ready
		.sink_valid         (irq_s1_agent_rp_valid),                         //          .valid
		.sink_data          (irq_s1_agent_rp_data),                          //          .data
		.sink_startofpacket (irq_s1_agent_rp_startofpacket),                 //          .startofpacket
		.sink_endofpacket   (irq_s1_agent_rp_endofpacket),                   //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_mux_003 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_mux_003 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_cmd_mux_003 cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_demux_003 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_demux_003 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_demux_003 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (rd_data_lsb_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	IO_contoller_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	IO_contoller_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (rd_data_lsb_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (rd_data_lsb_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (rd_data_lsb_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (rd_data_lsb_s1_agent_rdata_fifo_src_ready),     //         .ready
	...
	IO_contoller_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (rd_data_lsb_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (rd_data_msb_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (rd_data_msb_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (rd_data_msb_s1_agent_rdata_fifo_src_ready),     //         .ready
	...
	IO_contoller_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (rd_data_lsb_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (we_data_lsb_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (we_data_lsb_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (we_data_lsb_s1_agent_rdata_fifo_src_ready),     //         .ready
	...
	IO_contoller_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (rd_data_lsb_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (we_data_msb_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (we_data_msb_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (we_data_msb_s1_agent_rdata_fifo_src_ready),     //         .ready
	...
	IO_contoller_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (rd_data_lsb_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (we_s1_agent_rdata_fifo_src_data),               //     in_0.data
		.in_0_valid     (we_s1_agent_rdata_fifo_src_valid),              //         .valid
		.in_0_ready     (we_s1_agent_rdata_fifo_src_ready),              //         .ready
	...
	IO_contoller_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (rd_data_lsb_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (irq_s1_agent_rdata_fifo_src_data),              //     in_0.data
		.in_0_valid     (irq_s1_agent_rdata_fifo_src_valid),             //         .valid
		.in_0_ready     (irq_s1_agent_rdata_fifo_src_ready),             //         .ready
